/**
 * LandingPage — LP de conversão premium da Genuíno Gran (/orcamento).
 *
 * Efeitos WOW:
 *  - Hero com paralaxe 3D (mouse desktop + giroscópio mobile)
 *  - Comparador antes/depois interativo (drag slider)
 *  - CoverFlow 3D de projetos reais (CSS perspective)
 *  - Scroll cinematográfico com Framer Motion (reveals + stagger)
 */
