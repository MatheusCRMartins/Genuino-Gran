...
function LeadForm({ id = 'lead-form' }) {
  ...
  return (
    <form id={id} onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
      ...
      />
      {error && (
        <p className="font-inter text-xs text-red-400/80">{error}</p>
      )}
      <button
        type="submit"
        disabled={submitting}
...
function LPHeader() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 lg:px-10 py-4 bg-[#0a0a0a]/90 backdrop-blur-sm border-b border-white/[0.06]">
...
function Hero() {
  return (
    <section className="relative pt-16 min-h-screen flex items-center bg-[#0a0a0a] overflow-hidden">
      <div
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10 py-16 lg:py-0 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">

          {/* Conteúdo */}
          <div className="lg:py-20">
            <div className="inline-flex items-center gap-2 px-4 py-2 border border-gold/30 bg-gold/5 mb-6">
            ...
            <h1 className="font-playfair text-3xl sm:text-4xl lg:text-5xl xl:text-[3.2rem] font-medium text-white leading-[1.15] mb-6">
              Bancada de cozinha em mármore{' '}
              <em className="not-italic text-gold">sob medida em 10 dias</em>
            </h1>

            <p className="font-inter text-[15px] text-white/55 leading-relaxed mb-8 max-w-lg">
              Mais de 14 anos de experiência, +4 mil projetos entregues e garantia de 5 anos em
              cada obra. Sem taxa de deslocamento.
            </p>
            ...
            <div className="grid grid-cols-4 gap-2 sm:gap-3 mb-8">
              {[
                ...
                <div
                  key={item.l}
                  className="text-center py-3 border border-white/[0.07]"
                ...
                >
                  ...
                  <p className="font-inter text-[9px] text-white/35 tracking-wide mt-1">{item.l}</p>
                </div>
              ))}
            </div>
            ...
            <p className="font-inter text-xs text-white/30 flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {steps.map((step, i) => (
            ...
            >
              {i < steps.length - 1 && (
                <div
                  className="hidden md:block absolute top-1/2 -right-2.5 w-5 h-px bg-gold/25 z-10"
                  aria-hidden="true"
                />
              )}
          ...
          <div>
            ...
            <div className="flex items-center gap-4 pt-5 border-t border-white/[0.07]">
              ...
              <div>
                ...
                <p className="font-inter text-[10px] text-gold/60 tracking-wide uppercase">
    ...
    <section className="py-16 sm:py-20 bg-[#0a0a0a]">
      <div className="max-w-3xl mx-auto px-6 lg:px-10">
        <div className="text-center mb-10">
          ...
          <h2 className="font-playfair text-2xl sm:text-3xl font-medium text-white">
        ...
        <div className="flex flex-col divide-y divide-white/[0.07]">
          {LP_FAQ.map((item, i) => (
            <div key={i}>
              ...
              >
                ...
                >
                  <svg viewBox="0 0 12 12" fill="none" className="w-3 h-3">
                    <path
                      d="M6 2v8M2 6h8"
                      stroke={open === i ? '#c9a96e' : 'rgba(255,255,255,0.4)'}
                      strokeWidth="1.2"
                      strokeLinecap="round"
                    />
                  </svg>
              ...
              {open === i && (
                <p className="font-inter text-sm text-white/50 leading-relaxed pb-5 pr-9">
                  {item.a}
                </p>
              )}
            </div>
    ...
    <footer className="border-t border-white/[0.06] bg-[#080808] py-6">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-5">
          <Link to="/" className="font-inter text-[11px] text-white/25 hover:text-white/50 transition-colors">
            Site principal
          </Link>
