...
function WhatsAppButton() {
  return (
    ...
    >
      {/* Anel de pulso externo — chama atenção de forma sutil */}
      ...
      >
        {/* Ícone WhatsApp — versão limpa e minimal */}
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <main>
        ...
        {/* ── Divisor 3: visão ampla da cozinha premium ── */}
        <ParallaxDivider
