      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-x-12 xl:gap-x-20 gap-y-16 lg:items-stretch">
          ...
          >
            ...
            {/* ── Desktop: stats centralizados + CTA abaixo ── */}
            <div className="lg:flex-1 lg:flex lg:flex-col lg:justify-center lg:gap-6 mt-8 lg:mt-0">
              ...
              {/* CTA — mobile: full width. Desktop: centralizado */}
              <div className="lg:flex lg:justify-center mt-5 lg:mt-0">
                <a
                  href={WA_URL}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group inline-flex items-center gap-3 px-8 py-4 border border-gold/40 hover:bg-gold transition-all duration-300 w-full lg:w-auto lg:justify-center"
                >
                  <svg
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="w-5 h-5 text-gold group-hover:text-[#0a0a0a] flex-shrink-0 transition-colors"
                    aria-hidden="true"
                  >
                  ...
                  <div className="flex flex-col items-start lg:items-center">
                    <span className="font-inter text-[9px] tracking-[0.25em] uppercase text-gold/70 group-hover:text-[#0a0a0a]/70 transition-colors">
                      Fale diretamente
                    </span>
                    <span className="font-playfair text-base text-white group-hover:text-[#0a0a0a] transition-colors">
