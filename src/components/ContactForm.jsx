            ...
            {submitted ? (
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-7 sm:gap-8">
                  <Field label="Como você se chama? *" error={errors.nome}>
                    <input
                      type="text"
                      className={inputBase}
                  ...
                  <Field label="Seu WhatsApp *" error={errors.whatsapp}>
                    <input
                      type="tel"
                      className={inputBase}
                ...
                <Field label="E-mail (se preferir)" error={errors.email}>
                  <input
                    type="email"
                    className={inputBase}
                ...
                <Field label="O que você precisa? *" error={errors.tipo}>
                  <select
                ...
                <Field label="Me conta um pouco *" error={errors.mensagem}>
                  <textarea
                    rows={4}
